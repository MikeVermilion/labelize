...
static CHARACTER_SETS_013: [[&str; 11]; 14] = [
    ["#", "0", "@", "[", "\u{00A2}", "]", "^", "`", "{", "|", "}"],
    ["#", "0", "@", "\u{2153}", "\u{00A2}", "\u{2154}", "^", "`", "\u{00BC}", "\u{00BD}", "\u{00BE}"],
    ["\u{00A3}", "0", "@", "[", "\u{00A2}", "]", "^", "`", "{", "|", "}"],
    ["\u{0192}", "0", "\u{00A7}", "[", "IJ", "]", "^", "`", "{", "ij", "}"],
    ["#", "0", "@", "\u{00C6}", "\u{00D8}", "\u{00C5}", "^", "`", "\u{00E6}", "\u{00F8}", "\u{00E5}"],
    ["\u{00DC}", "0", "\u{00C9}", "\u{00C4}", "\u{00D6}", "\u{00C5}", "\u{00DC}", "\u{00E9}", "\u{00E4}", "\u{00F6}", "\u{00E5}"],
    ["#", "0", "\u{00A7}", "\u{00C4}", "\u{00D6}", "\u{00DC}", "^", "`", "\u{00E4}", "\u{00F6}", "\u{00FC}"],
    ["\u{00A3}", "0", "\u{00E0}", "[", "\u{00E7}", "]", "^", "`", "\u{00E9}", "|", "\u{00F9}"],
    ["#", "0", "\u{00E0}", "\u{00E2}", "\u{00E7}", "\u{00EA}", "\u{00EE}", "\u{00F4}", "\u{00E9}", "\u{00F9}", "\u{00E8}"],
    ["\u{00A3}", "0", "\u{00A7}", "[", "\u{00E7}", "\u{00E9}", "^", "\u{00F9}", "\u{00E0}", "\u{00F2}", "\u{00E8}"],
    ["#", "0", "\u{00A7}", "\u{00A1}", "\u{00D1}", "\u{00BF}", "^", "`", "{", "\u{00F1}", "\u{00E7}"],
    ["\u{00A3}", "0", "\u{00C9}", "\u{00C4}", "\u{00D6}", "\u{00DC}", "^", "\u{00E4}", "\u{00EB}", "\u{00EF}", "\u{00F6}"],
    ["#", "0", "@", "[", "\u{00A5}", "]", "^", "`", "{", "|", "}"],
    ["#", "0", "@", "[", "\\", "]", "^", "`", "{", "|", "}"],
];
